  ...
  <tr>
    ...
    <td width="600">
        <table width="600" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="600" height="20" align="center" style="font-size:10px;font-family:Arial;color:#555"><a href="[[view_this_message]]">Visualize esta mensagem no navegador</a>.</td>
          </tr>
          <tr>
