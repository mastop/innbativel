...
<center>
    <table width="600" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="center"><img src="https://{{Configuration::get("s3url")}}/praia-boleto.jpg" width="600" height="300" alt="" style="display:block;"></td>
      </tr>
      <tr>
        <td align="center" bgcolor="#4060a6"><table width="510" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td align="left" style="font-family:Arial, Helvetica, sans-serif; font-size:17px; color:#FFF;"><a href="{{ $boletus_url }}" target="_blank" style="font-family:Arial, Helvetica, sans-serif; color:#FFF; text-decoration: none; color:#f0cf31;">Acesse aqui o boleto de pagamento</a></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
