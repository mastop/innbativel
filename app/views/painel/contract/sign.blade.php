@section('content')
    ...
    <div class="well widget row-fluid">
        ...
        <div class="control-group required">
            <label for="date" class="control-label">Data de hoje</label>
            <div class="controls">{{ date("d/m/Y") }}</div>
        </div>
        <div class="control-group required">
            <label for="date_now" class="control-label">Seu IP</label>
            <div class="controls">{{ $ip }}</div>
        </div>

        {{ Former::checkbox('agreed', 'Li e estou de acordo')->class('span12') }}

        {{ Former::actions()
          ->primary_submit('Assinar') }}
