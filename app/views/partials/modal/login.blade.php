                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-8">
                            <a class="img-link" href="{{ route('facebook', array('destination' => e(Input::get('destination', Request::getPathInfo())))) }}"><img src="//{{Configuration::get("s3url")}}/fb-login.png" alt="Faça login com sua conta do Facebook"></a>
                        </div>
                    </div>
                    <hr>
                    <div class="form-group">
